...
// Execute provides a mock function with given fields: parnet, px, id
func (_m *CreateIProxyContainer) Execute(parnet handler.IProxySpawner, px handler.IProxy, id int) (handler.IProxyContainer, error) {
	ret := _m.Called(parnet, px, id)
