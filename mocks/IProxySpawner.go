...
// GetProxyAddr provides a mock function with given fields:
func (_m *IProxySpawner) GetProxyAddr() net.Addr {
	ret := _m.Called()
...
func (_m *IProxySpawner) SendToAllClients(data []byte) {
	_m.Called(data)
}

// SendToAllServers provides a mock function with given fields: data
func (_m *IProxySpawner) SendToAllServers(data []byte) {
	_m.Called(data)
}
...
// SetSendCallback provides a mock function with given fields: cb
func (_m *IProxySpawner) SetSendCallback(cb handler.PacketSendCallback) {
	_m.Called(cb)
}
