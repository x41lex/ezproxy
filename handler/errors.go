...
var (
	...
	ErrProxyRetry      error = errors.New("proxy cloesd retrying")              // The proxy was closed but should be restarted, if this error is returned 3 times the proy will be killed
)
